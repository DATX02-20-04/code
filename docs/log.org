...
*** Pitch conditioning and Auxillary Classifier
...
#+CAPTION: Overview of how a Auxillary Classifier GAN works (ACGAN)
#+NAME: fig:aux_overview
[[./img/aux_class_overview.png]]

The /ACGAN/ in figure [[fig:aux_overview]] shows pitch class as $c$, noise input as
...
#+CAPTION: Result at 1500K steps
#+NAME: fig:1500k_steps
[[./img/1500k_steps.png]]

{{{AUDIO(audio/1500k_steps.wav)}}}
...
[[fig:1500k_steps]], there are three kidns of images, of which only one of them
