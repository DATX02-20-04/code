...
- *Lovisa*:
  - Worked mostly on the background and loss functions sections of the report.
  - Also did some reviews on github, participated in meetings and some collective work on the ACGAN.
  - Still troubled by ongoing family issues.
...
- *Lovisa*:
  ...
  - Had some family issues arise that consumed lots of time and energy.
- *Cao*:
