...
** Exhibition
Elias wrote and recorded a video for the exhibition in week 14. This allows us
to solely focus on report and demo, which is great.
** Structure generator
...
Most of us have been working on the report, all of us are working all over the
report due to the sprint stuff, but in general, these are the sections we are
responsible for:
- *Christoffer*:
...
** Next few weeks
I will most likely update again in week 17 (when the report is due) since it'd
...
this, we have increased the resolution of spectrograms to $128 \times 256$, it
double the number of frequency 'bins'.
...
To use this, we simple switch which function to use. Figure [[fig:cqt_exp_1]]
