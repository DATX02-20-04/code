...
#+caption: An example of a $128 \times 512$ spectrogram. Not the very tiny horizontal bars at the bottom, indicating that the sample frequency is to low to fill those bins.
...
improve with the Constant Q transform.

#+begin_column
#+CAPTION: A melody generated by an untrained transformer, performed by a GAN
#+NAME: fig:gen_melody_no_train
