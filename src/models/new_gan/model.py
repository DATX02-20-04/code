...
class GAN(tfk.Model):
    def __init__(self, hparams, stats, init_size):
        ...
        self.discriminators = self.create_discriminator([*init_size, 1])
    ...
    def create_generator(self, in_dim):
        ...
        out_image = tfkl.Conv2D(1, (1,1), padding='same', activation='tanh', kernel_initializer=init, kernel_constraint=const)(g)
